...
const DashboardBusinessPage = () => {
  ...
  const form = useForm<BusinessInputsType>({
    defaultValues: {},
  });
  const [create, createResponse] = useCreateBusinessMutation();

  const handleOpen = () => setOpen(!open);

  const onSubmit = async (data: BusinessInputsType) => {
