...
const DashboardServicePage = () => {
  ...
  const form = useForm<ServiceInputsType>({
    defaultValues: {},
  });
  const [create, createResponse] = useCreateServiceMutation();

  const handleOpen = () => setOpen(!open);

  const onSubmit = async (data: ServiceInputsType) => {
          ...
          >
            <div className="mb-1 flex flex-col gap-6">
              ...
              <div>
                ...
                />
                <ErrorMessage errors={form.formState.errors} name="hours" />
              </div>
              <div>
                <Typography variant="h6" color="blue-gray" className="">
                  Contact
                ...
                />
                <ErrorMessage errors={form.formState.errors} name="contact" />
              </div>
              <div>
                <Typography variant="h6" color="blue-gray" className="">
                  Category
